    ...
    private Figure createFigure(double x, double y) throws FigureException {
        ...
        switch (random.nextInt(5)) {
            ...
            case Figure.FIGURE_TYPE_RECTANGLE:
                figure = new Rectangle(x, y, random.nextInt(5), Color.RED, random.nextInt(100), random.nextInt(100));
                break;
            case Figure.FIGURE_TYPE_TRIANGLE:
                figure = new Triangle(x, y, random.nextInt(5), Color.BLUE, random.nextInt(100));
                break;
            case Figure.FIGURE_TYPE_PENTAGON:
                figure = new Pentagon(x, y, random.nextInt(5), Color.BROWN, random.nextInt(100));
                break;
            case Figure.FIGURE_TYPE_HEXAGON:
                figure = new Hexagon(x, y, random.nextInt(5), Color.GRAY, random.nextInt(100));
                break;
            default:
